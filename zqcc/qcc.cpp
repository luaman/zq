...
// print header with GNU copyleft notice:
	out += sprintf (out, "/*\nCopyright (C) 1996-1997 Id Software, Inc.\n\n");
	out += sprintf (out, "This program is free software; you can redistribute it and/or\n");
	out += sprintf (out, "modify it under the terms of the GNU General Public License\n");
	out += sprintf (out, "as published by the Free Software Foundation; either version 2\n");
	out += sprintf (out, "of the License, or (at your option) any later version.\n\n");
	out += sprintf (out, "This program is distributed in the hope that it will be useful,\n");
	out += sprintf (out, "but WITHOUT ANY WARRANTY; without even the implied warranty of\n");
	out += sprintf (out, "MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.\n\n");

	out += sprintf (out, "See the GNU General Public License for more details.\n\n");

	out += sprintf (out, "You should have received a copy of the GNU General Public License\n");
	out += sprintf (out, "along with this program; if not, write to the Free Software\n");
	out += sprintf (out, "Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA  02111-1307, USA.\n*/\n\n");
...
// do a crc of the file
	...
	out += sprintf (out, "#endif /* _PROGDEFS_H_ */\n\n");
