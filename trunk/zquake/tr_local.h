...
#include "q_shared.h"
#include "q3defs.h"
#include "q3surfaceflags.h"
#include "qfiles.h"
#include "cvar.h"

//#include "common.h"
//#include "bspfile.h"	// FIXME, gonna fuck things up?
...
typedef struct {
	...
	int						overbrightBits;		// r_overbrightBits->value, but set to 0 if no hw gamma
